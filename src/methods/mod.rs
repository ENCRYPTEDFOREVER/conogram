...
pub mod answer_chat_join_request_query;
pub mod answer_guest_query;
...
pub mod delete_all_message_reactions;
...
pub mod edit_ephemeral_message_caption;
pub mod edit_ephemeral_message_media;
pub mod edit_ephemeral_message_reply_markup;
pub mod edit_ephemeral_message_text;
...
pub mod get_managed_bot_access_settings;
...
pub mod get_user_personal_chat_messages;
...
pub mod send_chat_join_request_web_app;
...
pub mod send_photo;
pub mod send_poll;
pub mod send_rich_message;
pub mod send_rich_message_draft;
...
pub mod set_managed_bot_access_settings;
