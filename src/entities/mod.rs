...
pub mod bot_subscription_updated;
...
pub mod community;
pub mod community_chat_added;
pub mod community_chat_removed;
pub mod contact;
...
pub mod input_media_link;
pub mod input_media_live_photo;
pub mod input_media_location;
pub mod input_media_photo;
pub mod input_media_sticker;
pub mod input_media_venue;
pub mod input_media_video;
pub mod input_media_voice_note;
pub mod input_message_content;
pub mod input_paid_media;
pub mod input_paid_media_live_photo;
pub mod input_paid_media_photo;
pub mod input_paid_media_video;
pub mod input_poll_media;
pub mod input_poll_option;
pub mod input_poll_option_media;
pub mod input_profile_photo;
pub mod input_profile_photo_animated;
pub mod input_profile_photo_static;
pub mod input_rich_block;
pub mod input_rich_block_anchor;
pub mod input_rich_block_animation;
pub mod input_rich_block_audio;
pub mod input_rich_block_block_quotation;
pub mod input_rich_block_collage;
pub mod input_rich_block_details;
pub mod input_rich_block_divider;
pub mod input_rich_block_footer;
pub mod input_rich_block_list;
pub mod input_rich_block_list_item;
pub mod input_rich_block_map;
pub mod input_rich_block_mathematical_expression;
pub mod input_rich_block_paragraph;
pub mod input_rich_block_photo;
pub mod input_rich_block_preformatted;
pub mod input_rich_block_pull_quotation;
pub mod input_rich_block_section_heading;
pub mod input_rich_block_slideshow;
pub mod input_rich_block_table;
pub mod input_rich_block_thinking;
pub mod input_rich_block_video;
pub mod input_rich_block_voice_note;
pub mod input_rich_message;
pub mod input_rich_message_content;
pub mod input_rich_message_media;
...
pub mod rich_block;
pub mod rich_block_anchor;
pub mod rich_block_animation;
pub mod rich_block_audio;
pub mod rich_block_block_quotation;
pub mod rich_block_caption;
pub mod rich_block_collage;
pub mod rich_block_details;
pub mod rich_block_divider;
pub mod rich_block_footer;
pub mod rich_block_list;
pub mod rich_block_list_item;
pub mod rich_block_map;
pub mod rich_block_mathematical_expression;
pub mod rich_block_paragraph;
pub mod rich_block_photo;
pub mod rich_block_preformatted;
pub mod rich_block_pull_quotation;
pub mod rich_block_section_heading;
pub mod rich_block_slideshow;
pub mod rich_block_table;
pub mod rich_block_table_cell;
pub mod rich_block_thinking;
pub mod rich_block_video;
pub mod rich_block_voice_note;
pub mod rich_message;
pub mod rich_text;
pub mod rich_text_anchor;
pub mod rich_text_anchor_link;
pub mod rich_text_bank_card_number;
pub mod rich_text_bold;
pub mod rich_text_bot_command;
pub mod rich_text_cashtag;
pub mod rich_text_code;
pub mod rich_text_custom_emoji;
pub mod rich_text_date_time;
pub mod rich_text_email_address;
pub mod rich_text_hashtag;
pub mod rich_text_italic;
pub mod rich_text_marked;
pub mod rich_text_mathematical_expression;
pub mod rich_text_mention;
pub mod rich_text_phone_number;
pub mod rich_text_reference;
pub mod rich_text_reference_link;
pub mod rich_text_spoiler;
pub mod rich_text_strikethrough;
pub mod rich_text_subscript;
pub mod rich_text_superscript;
pub mod rich_text_text_mention;
pub mod rich_text_underline;
pub mod rich_text_url;
pub mod sent_guest_message;
